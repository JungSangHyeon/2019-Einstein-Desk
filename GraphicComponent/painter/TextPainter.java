...
public class TextPainter extends AComponentPainter {
	...
	public void paintComponent(Graphics g, Shape shape) {
		...
		if(rect.getWidth()<rect.getHeight()) {
			if (img != null) {g.drawImage(img, rectX+imgLeftGap, rectY+imgUpDownGap, rectW-imgLeftGap*2, rectW-imgUpDownGap*2, null);}
			...
			if(nameSize>minTextSize) {
				...
				g.drawString(name, rectX+imgLeftGap, (int) (rectY+rectW +( nameSize*textYFactor*2+imgUpDownGap) ));
			}
		}else {
