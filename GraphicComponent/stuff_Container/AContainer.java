...
import su_ScrollPanel.SU_AffineScrollPanel;

@SuppressWarnings("serial")
public abstract class AContainer extends SU_AffineScrollPanel {//호호 드럽다. 
	...
	public void setItemMovable(boolean boo) {this.movable = boo;}
...
//		}
	...
	public class MouseHandler implements MouseListener, MouseMotionListener{//TODO
		...
		public void mouseDragged(MouseEvent e) {
			if(copyCurrentItem!=null&&movable) {
				dragStartAction();
				changeSeat();
	...
	public void findCurrentShape(MouseEvent e) {
		for(int i=itemVector.size()-1; i>-1; i--) {
			if(itemVector.get(i).getRect().contains(transformPoint(e.getPoint()))) {
				...
				if(movable) {copyCurrentItem = (Item) DeepClone.clone(currentItem);}
				break;
			}
		}
	}
