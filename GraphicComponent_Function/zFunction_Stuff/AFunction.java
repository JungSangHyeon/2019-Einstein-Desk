...
public abstract class AFunction  implements Serializable{
	...
	public void paint(Graphics2D g){
		if(paintOn) {
			...
			realPaint(g);
			for(AFunction function : aggregateFunction) {function.paint(g);}
